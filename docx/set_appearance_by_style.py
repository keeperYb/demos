...
test_docx_file = r'D:\desktop_files_and_folders\word\test_format.docx'
original_docx_file = r'D:\desktop_files_and_folders\word\表20.docx'
target_docx_file = r'D:\desktop_files_and_folders\word\表20 - 副本.docx'
...
if __name__ == '__main__':
    ...
    # read_para_style()
    # '''
    # the_para_dict_origin has these keys:
    # # table_name_style
    # # table_style
    # # '''
    # handle_table_style()
    ...
    # draw_table_in_docx(the_para_dict_origin)
    # '''end main area'''
